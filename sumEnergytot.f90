...
open(22,file='hot.engtot')
open(23,file='hole.engtot')
do i=1,nn
    tp=(i-1)*tg
    write(6,*) tp
   if(tp==0) then
   ...
   ! write(22,'(6(F12.5))') tp,(hotenergy(k),k=1,5)
    ...
    write(22,'(8(E12.5))') tp,(hotenergy(k),k=1,5),sum(hotenergy),(sum(hotenergy)+sum(holeenergy))
    write(23,'(7(E12.5))') tp,(holeenergy(k),k=1,5),sum(holeenergy)
 enddo
close(22)
close(23)
