...
character*30::fileName,outputName,apd,arg
...
open(22,file='hot.occ')
open(23,file='hole.occ')
open(24,file='maxmhot.occ')
do i=1,nn
    tp=(i-1)*tg
    write(6,*) tp
   if(tp==0) then
