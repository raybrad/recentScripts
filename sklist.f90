...
call get_environment_variable ('HOME', match, len, istat, .true.)
  ...
  case(1)
    select case(j)
    case(1)
      skfile = match(1:len)//'/lodestar/DFTB/trunk/sk/mio-0-1/H-H.skf'
    case(6)
      skfile = match(1:len)//'/lodestar/DFTB/trunk/sk/mio-0-1/H-C.skf'
    case(7)
      skfile = match(1:len)//'/lodestar/DFTB/trunk/sk/mio-0-1/H-N.skf'
    case(8)
...
!     skfile = match(1:len)//'/lodestar/DFTB/trunk/sk/ph'
  ...
  case(6)
    select case(j)
    case(1)
      skfile = match(1:len)//'/lodestar/DFTB/trunk/sk/mio-0-1/C-H.skf'
    case(6)
      skfile = match(1:len)//'/lodestar/DFTB/trunk/sk/mio-0-1/C-C.skf'
    case(7)
      skfile = match(1:len)//'/lodestar/DFTB/trunk/sk/mio-0-1/C-N.skf'
    case(8)
...
!     skfile = match(1:len)//'/lodestar/DFTB/trunk/sk/cp'
  ...
  case(7)
    select case(j)
    case(1)
      skfile = match(1:len)//'/lodestar/DFTB/trunk/sk/mio-0-1/N-H.skf'
    case(6)
      skfile = match(1:len)//'/lodestar/DFTB/trunk/sk/mio-0-1/N-C.skf'
    case(7)
      skfile = match(1:len)//'/lodestar/DFTB/trunk/sk/mio-0-1/N-N.skf'
    case(8)
